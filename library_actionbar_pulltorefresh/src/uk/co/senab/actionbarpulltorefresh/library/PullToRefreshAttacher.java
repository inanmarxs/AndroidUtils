...
public class PullToRefreshAttacher {
	...
	protected PullToRefreshAttacher(ActionBarActivity activity, Options options) {
		if (activity == null) {
	...
	protected EnvironmentDelegate createDefaultEnvironmentDelegate() {
		return new EnvironmentDelegate() {
			@Override
			public Context getContextForInflater(ActionBarActivity activity) {
	...
	protected void addHeaderViewToActivity(View headerView) {
		if (mActivity == null || headerView == null) {
			return;
		}
