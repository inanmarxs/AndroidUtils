...
public class IO {
	...
	private static Client defaultClient() {
		if (mClient != null
				&& System.currentTimeMillis() - mClientUseTime > 3 * 60 * 1000) { // 1
																					// minute
			mClient.close();
			mClient = null;
		}
	 ...
	 *            回调函数
	 */
	public void put(String key, InputStreamAt isa, PutExtra extra,
			JSONObjectRet ret) {
	...
	public void putFile(String key, File file, PutExtra extra,
			JSONObjectRet callback) {
		putAndClose(key, InputStreamAt.fromFile(file), extra, callback);
	}

	public void putAndClose(final String key, final InputStreamAt input,
