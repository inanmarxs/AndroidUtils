	...
	public class ClientExecutor extends AsyncTask<Object, Object, Object>
		...
		protected Object doInBackground(Object... objects) {
			try {
				...
				if (statusCode == 401)
					return new Exception("unauthorized!"); // android 2.3 will
															// not response
				if (xl.contains("invalid BlockCtx"))
					return new Exception(xl);
				...
				if (xl.length() > 0)
					return new Exception(xl);
				return new Exception(resp.getStatusLine().getStatusCode() + ":"
